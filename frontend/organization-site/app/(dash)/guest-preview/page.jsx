...
const VisitForm = () => {
  ...
  const onSubmit = async (data) => {
    ...
    if (!isUserLoading) {
      ...
      formData.append("numAdultguest", value.adultguest);
      formData.append("numChildguest", value.childguest);
      formData.append("numofroom", value.numofroom);
      formData.append("type_of_id", value.typeid);
      formData.append("id_number", value.id_number);
      formData.append("advancedPayment", value.advancedPayment);
      formData.append("remainingPayment", value.remainingPayment);
      ...
      console.log(formData, ' guest previe page ');
          const res = await axiosInstance.post(`/organization/guestcreate/`, 
