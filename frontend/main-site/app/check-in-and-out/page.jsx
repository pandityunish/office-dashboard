...
<p className='font-bold text-[60px] font-inter text-center leading-[70px]'><span className='text-primaryblue'>Guest Check-In &</span><br />
<span className='text-primaryblue'>Check Out</span>  Solution  <br />for Hotel</p>
