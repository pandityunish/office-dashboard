...
<p className='font-bold text-[65px] font-inter text-center leading-[70px]'><span className='text-primaryblue'>Meeting management</span><br />
<span className='text-primaryblue'>systems</span>  Solution for <br /> workplace</p>

<div className='flex flex-col w-full relative  mt-14'>
<img src="/backgroundtop.png" alt="" className='w-full'/>
<Image src="/meetingpage.png" width={900} height={500} className='absolute left-1/2 transform  -translate-x-1/2 top-1' alt="some"/>
